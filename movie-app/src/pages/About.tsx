...
<div className="min-h-screen pt-28 bg-gradient-to-b from-navy-900 to-navy-700 dark:text-white text-black dark:bg-slate-600">
  <div className="max-w-2xl mx-auto text-center px-6">
    ...
    <p className="text-lg leading-relaxed mb-8">
      Welcome to YutaFlix, you can find the hottest movies and TV series trending today. Explore our curated selection of the most popular titles and find your next favorite.
    </p>
    <div className="border-t border-gray-500 mt-8 pt-8">
      <h3 className="text-2xl font-semibold mb-2">What Can You Do Here?</h3>
      <ul className="text-lg space-y-2">
        <li>
          <strong>Trending Movies & TV Series:</strong> Get a quick overview of what's trending in the entertainment world. Updated daily to bring you the latest hits.
        </li>
        <li>
